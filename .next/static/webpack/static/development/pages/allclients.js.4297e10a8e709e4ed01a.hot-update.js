...
var AllClients = function AllClients(allClients) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    setClients([allClients[0].json]); //     if (statusUrl !== "") {
    //       axios
    //         .get(`${statusUrl}/api/getclients`)
    //         .then(response => setClients([...response.data]))
    //         .catch(err => console.log(err));
    //     }
  }, [allClients !== 0]); // }, [statusUrl]);
  ...
  return __jsx("div", {
    ...
    __self: this
  }, clients.length !== 0 ? clients.map(function (client) {
    return __jsx("div", {
      key: client.id,
...
//# sourceMappingURL=allclients.js.4297e10a8e709e4ed01a.hot-update.js.map